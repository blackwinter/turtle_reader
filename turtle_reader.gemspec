# -*- encoding: utf-8 -*-
# stub: turtle_reader 0.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.licenses = ["AGPL-3.0"]
  s.post_install_message = "\nturtle_reader-0.0.1 [2014-04-30]:\n\n* First release (extracted from ruby-nuggets).\n\n"
  s.rdoc_options = ["--title", "turtle_reader Application documentation (v0.0.1)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
